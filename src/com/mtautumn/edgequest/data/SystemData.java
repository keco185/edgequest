...
public class SystemData {
	...
	public boolean characterLocationSet = false;
	...
	public boolean isKeyboardUp = false;		// work to remove
	public boolean isKeyboardRight = false;		// work to remove
	public boolean isKeyboardDown = false;		// work to remove
	public boolean isKeyboardLeft = false;		// work to remove
	public boolean isKeyboardSprint = false;	// work to remove
	...
	public boolean isKeyboardTravel = false;	// work to remove
	public boolean isAiming = false;			// work to remove
	public boolean isMoveInput = false;
